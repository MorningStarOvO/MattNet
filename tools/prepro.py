...
if __name__ == '__main__':
  ...
  # ----- 指定包含图片和四个数据 JSON 的文件路径 ----- #
  parser.add_argument('--data_root', default='/home/data/yjgroup/qxy/qxy/CM-Att-Erase/data', type=str, help='data folder containing images and four datasets.')
